...
export const DEFAULTS_CONCEDIDOS_FASE_10 = {
  VENDEDOR: [
    ...DEFAULTS_CONCEDIDOS_FASE_9.VENDEDOR,
    VENDAS_PERMISSOES.PEDIDO_VER,
    VENDAS_PERMISSOES.PEDIDO_COBRANCA_VER,
  ],
  GESTOR: [
    ...DEFAULTS_CONCEDIDOS_FASE_9.GESTOR,
    VENDAS_PERMISSOES.PEDIDO_VER,
    VENDAS_PERMISSOES.PEDIDO_CANCELAR,
    VENDAS_PERMISSOES.PEDIDO_COBRANCA_VER,
  ],
  FINANCEIRO: [
    ...DEFAULTS_CONCEDIDOS_FASE_9.FINANCEIRO,
    VENDAS_PERMISSOES.PEDIDO_VER,
    VENDAS_PERMISSOES.PEDIDO_COBRANCA_VER,
  ],
  ADMIN: [
    ...DEFAULTS_CONCEDIDOS_FASE_9.ADMIN,
    VENDAS_PERMISSOES.PEDIDO_VER,
    VENDAS_PERMISSOES.PEDIDO_CANCELAR,
    VENDAS_PERMISSOES.PEDIDO_COBRANCA_VER,
  ],
