...
@ApiTags('Test - Campos de Validação')
@Controller('test-campos-validacao')
export class TestCamposValidacaoController {
  @Get()
  @ApiOperation({ summary: 'Teste - Listar campos sem autenticação' })
  listarCampos(): CampoValidacao[] {
    return [
      ...
      },
      {
        ...
        descricao: 'Quantidade disponível em estoque (campo legado)',
        tipo: 'number',
        modulo: 'Material',
        exemplo: '50',
      },
