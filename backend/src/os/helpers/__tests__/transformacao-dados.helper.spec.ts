...
describe('TransformacaoDadosHelper', () => {
  describe('calcularPrazoProducaoDias', () => {
    ...
    it('deve usar horas por dia personalizadas', () => {
      expect(TransformacaoDadosHelper.calcularPrazoProducaoDias(20, 10)).toBe(
        2,
      );
  ...
  describe('converterPrazoEntregaParaData', () => {
    ...
    it('deve converter texto simples', () => {
      const data = TransformacaoDadosHelper.converterPrazoEntregaParaData(
        '5 dias',
        dataAbertura,
      );
  ...
  describe('extrairMateriaisPrincipais', () => {
    ...
    it('deve retornar top 3 materiais por custo', () => {
      const materiais =
        TransformacaoDadosHelper.extrairMateriaisPrincipais(insumosMock);
    ...
    it('deve filtrar insumos sem custo', () => {
      ...
      const materiais =
        TransformacaoDadosHelper.extrairMateriaisPrincipais(insumosComZero);
      expect(materiais).toHaveLength(3);
    });
  ...
  describe('identificarTipoImpressao', () => {
    ...
    it('deve identificar tipo predominante', () => {
      const tipo =
        TransformacaoDadosHelper.identificarTipoImpressao(maquinasMock);
  ...
  describe('extrairAcabamentos', () => {
    ...
    it('deve filtrar serviços de instalação', () => {
      const acabamentos =
        TransformacaoDadosHelper.extrairAcabamentos(servicosMock);
  ...
  describe('verificarInstalacaoNecessaria', () => {
    it('deve retornar true quando há instalação', () => {
      ...
      const necessaria =
        TransformacaoDadosHelper.verificarInstalacaoNecessaria(servicos);
  ...
  describe('transformarDadosCompletos', () => {
    const dadosOrcamentoMock = {
      ...
      maquinas: [{ tipo: 'DIGITAL', nome: 'Impressora' }],
      servicosManuais: [
        { nome: 'Laminação', categorias: ['acabamento'], custo_total: 50 },
      ],
    };
    ...
    it('deve transformar dados completos', () => {
      const dados =
        TransformacaoDadosHelper.transformarDadosCompletos(dadosOrcamentoMock);
  ...
  describe('validarDadosTransformados', () => {
    ...
    it('deve validar dados corretos', () => {
      const validacao =
        TransformacaoDadosHelper.validarDadosTransformados(dadosValidos);
    ...
    it('deve detectar dados inválidos', () => {
      ...
      const validacao =
        TransformacaoDadosHelper.validarDadosTransformados(dadosInvalidos);
  ...
  describe('formatarParaExibicao', () => {
    ...
    it('deve formatar dados para exibição', () => {
      const formatado =
        TransformacaoDadosHelper.formatarParaExibicao(dadosMock);
