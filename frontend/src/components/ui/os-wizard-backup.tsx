                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => setValue('departamento_solicitante', value)}>
                      <SelectTrigger className={errors.departamento_solicitante ? 'border-red-500' : ''}>
                    ...
                    {errors.departamento_solicitante && (
                      <p className="text-sm text-red-500">{errors.departamento_solicitante.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={errors.centro_custo ? 'border-red-500' : ''}
                    />
                    {errors.centro_custo && (
                      <p className="text-sm text-red-500">{errors.centro_custo.message}</p>
                    )}
                  </div>
                </>
              )}
            ...
            {tipoOS === 'INTERNA' && (
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                  className={errors.justificativa_interna ? 'border-red-500' : ''}
                />
                {errors.justificativa_interna && (
                  <p className="text-sm text-red-500">{errors.justificativa_interna.message}</p>
                )}
              </div>
            )}
