          ...
          <CommandList>
            ...
            <CommandGroup>
              {tiposMaquinas.map((tipo) => (
                <CommandItem key={tipo.value} value={tipo.label} onSelect={() => { onValueChange(tipo.value); setOpen(false); }}>
  ...
  return (
    <div className="w-full max-w-none">
      ...
      <Card className="w-full">
        <CardHeader>
          <CardTitle>{initialData ? 'Editar Máquina' : 'Nova Máquina'}</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <FormField control={form.control} name="tipo" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <TipoMaquinaCombobox value={field.value} onValueChange={field.onChange} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <FormField control={form.control} name="modo_producao" render={({ field }) => (
                  <FormItem>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FormField control={form.control} name="velocidade_m2_h" render={({ field }) => (
                  <FormItem>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <FormField control={form.control} name="setup_min" render={({ field }) => (
                  <FormItem>
              ...
              <FormField control={form.control} name="observacoes" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Informações adicionais sobre a máquina..." className="min-h-[100px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
