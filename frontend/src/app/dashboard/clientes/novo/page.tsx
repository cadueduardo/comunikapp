      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="origem">Como conheceu a empresa</Label>
                <Input
                  id="origem"
              ...
              <div>
                <Label htmlFor="segmento">Setor de Atuação</Label>
                <Input
                  id="segmento"
        ...
        <div className="flex justify-end gap-4">
          <Link href="/dashboard/clientes">
            <Button type="button" variant="outline" className="cursor-pointer hover:bg-gray-100 transition-colors">
              Cancelar
            </Button>
          </Link>
          <Button type="submit" disabled={loading} className="cursor-pointer hover:bg-primary/90 transition-colors disabled:cursor-not-allowed">
