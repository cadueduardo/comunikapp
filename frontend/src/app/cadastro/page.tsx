...
export default function CadastroPage() {
    ...
    useEffect(() => {
        ...
        setFormData(prev => ({ ...prev, inviteCode: inviteToken }));
        setInviteLoading(true);
        platformApi.validateInvite(inviteToken)
            .then((response: any) => {
                if (response?.email) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await lojasApi.register(payload);
                    ...
                    <div className="mx-auto grid w-[400px] gap-6">
                        ...
                        <form onSubmit={handleSubmit} className="grid gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="inviteCode" value={formData.inviteCode} onChange={handleChange} placeholder="Cole o token ou use o link recebido" required disabled={loading || inviteLoading} autoComplete="off" />
                            </div>
                             <div className="grid gap-2">
