...
import { useFornecedorValidation } from "@/hooks/use-fornecedor-validation";
...
interface FornecedorFormProps {
  ...
  fornecedorId?: string; // Para validação de edição
}

export function FornecedorForm({ onSubmit, defaultValues, isSubmitting, fornecedorId }: FornecedorFormProps) {
  ...
  // Hook de validação
  const { isValidating, validationMessage: hookMessage, isValid } = useFornecedorValidation({
    nome,
    fornecedorId,
    token: token || '',
            ...
            <FormItem>
              ...
              <FormControl>
                <div className="relative">
                  <Input 
                    placeholder="Ex: Fornecedor de Lonas ABC" 
                    {...field} 
              ...
              {!validationMessage && isValid && nome.trim() && (
                <Alert className="mt-2 border-green-200 bg-green-50">
                  ...
                  <AlertDescription className="text-green-800">
                    Nome disponível! Este fornecedor pode ser cadastrado.
                  </AlertDescription>
                </Alert>
              )}
            </FormItem>
